...
const socialLinks = [
  {
    label: "Instagram",
    href: "https://instagram.com/andyalveycomedy",
    icon: (
  ...
  {
    label: "TikTok",
    href: "https://tiktok.com/@andyalveycomedy",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    label: "Facebook",
    href: "https://facebook.com/andyalveycomedy",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
        ...
        <div className="hidden md:flex items-center gap-4">
          {socialLinks.map((s) => (
            <a
              ...
              aria-label={s.label}
              className="text-white/60 hover:text-[#e8c84a] transition-colors"
            >
              {s.icon}
            </a>
          ))}
